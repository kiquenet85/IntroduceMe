...
public class PinnedHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private final static Paint backgroundHeader;
    static {
        backgroundHeader = new Paint();
        backgroundHeader.setStyle(Paint.Style.FILL);
        backgroundHeader.setColor(Color.rgb(0, 0, 0));
    }
